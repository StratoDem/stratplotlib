!https://github.com/StratoDem/stratplotlib/tree/kostas/img/title.png!
...
!https://github.com/StratoDem/stratplotlib/tree/kostas/img/ex_1.png!
...
m.show()```
!https://github.com/StratoDem/stratplotlib/tree/kostas/img/ex_2.png!

```m = Stratomap()
m.line(source=list_of_source, target=list_of_dest, color='red', weight=list_of_weights)
m.show()```
!https://github.com/StratoDem/stratplotlib/tree/kostas/img/ex_3.png!
